...
class _PaginateFirestoreState extends State<PaginateFirestore> {
      ...
      builder: (context, state) {
        if (state is PaginationInitial) {
          ...
          if (loadedState.documentSnapshots.isEmpty) {
            return _buildWithScrollView(context, widget.onEmpty,isScrollable: false);
          }
  ...
  Widget _buildWithScrollView(BuildContext context, Widget child,{bool isScrollable = true}) {
